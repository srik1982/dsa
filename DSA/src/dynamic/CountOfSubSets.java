...
public class CountOfSubSets {
	...
	public static void main(String[] args) {
		CountOfSubSets ss = new CountOfSubSets();
	    int[] num = {1, 1, 2, 3};
	...
	public int getSetCountBF(int numbers[], int sum) {
	...
	public int getSetCountTopDownDP(int []numbers, int sum) {
		Integer[][] dp = new Integer[numbers.length][sum+1];
		return getSetCountTopDownDP(numbers,0,dp,sum);
	}

	public int getSetCountTopDownDP(int[] numbers, int index, Integer[][] dp, int sum) {
		if(sum==0) return 1;
