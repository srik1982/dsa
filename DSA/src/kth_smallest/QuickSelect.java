...
public final class QuickSelect {
	...
	*/
	...
	private static int recursive(int[] array, int left, int right, int n) {
		System.out.println("recursive ("+left+" , "+right+" )");
	...
	*/
	private static int partition(int[] array, int left, int right, int pivotIndex) {
		System.out.println("Partitioning ( "+left+" , "+right+" )");
	...
	private static int randomPivot(int left, int right) {
  	...
  	public static void main(String[] args) {
  		int[] array = {6,-8,1,3,-2,5,4,9,77,16,6};
  		selectRecursive(array,5);
  		System.out.println(Arrays.toString(array));
  		recursive(array, 6, 10, 7);
  		System.out.println(Arrays.toString(array));
